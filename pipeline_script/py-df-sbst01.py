...
import argparse
from apache_beam.coders.coders import BytesCoder, Coder
...
from IgnoreUnicode import IgnoreUnicode
...
def del_unwanted_cols_fact(data):
    ...
    data.pop('dorder_receiveon', None)
...
table_id_itemmaster = 'SB_ITEMMASTER_MASTER_TESTING'  # replace with your table ID
...
table_id_dodt = 'SB_DODT_FACT_TESTING'  # replace with your table ID
...
# with beam.Pipeline(options=PipelineOptions) as p:
    branchessap_data = (p 
                        ...
                        | 'ReadData Branches_sap' >> beam.io.ReadFromText('gs://sb-data-source/data_source_20210501/BranchesSap_20210607_093034.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        ...
                        # | 'ReadData Branches_sap' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource_20210501/BranchesSap_20210728_140524.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData Branches_sap' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-01-10days/01-10days-BranchesSap_20210801_211616.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData Branches_sap' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-11-20days/11-20days-BranchesSap_20210801_213849.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData Branches_sap' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-21-31days/21-31days-BranchesSap_20210801_220059.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        ...
                        # | 'IgnoreUnicode Branches_sap' >> beam.Map(coder)
                        # | 'DecodeAndIgnoreUnicode Branches_sap' >> beam.Map(lambda line:line.decode("utf-8", "ignore"))
    ...
    transtypemicros_data = (p 
                        ...
                        | 'ReadData transtype micros' >> beam.io.ReadFromText('gs://sb-data-source/data_source_20210501/data_source_20210501_Transaction_Type_Micros_20210611_124914.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        ...
                        # | 'ReadData transtype micros' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource_20210501/Transaction_Type_Micros_20210730_090844.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData transtype micros' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-01-10days/01-10days-Transaction_Type_Micros_202108021.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData transtype micros' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-11-20days/11-20days-Transaction_Type_Micros_202108023.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData transtype micros' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-21-31days/21-31days-Transaction_Type_Micros_202108022.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        ...
                        # | 'IgnoreUnicode transtypemicros_data' >> beam.Map(coder)
                        # | 'DecodeAndIgnoreUnicode transtype micros' >> beam.Map(lambda line:line.decode("utf-8", "ignore"))
    ...
    transtypetime_data = (p 
                        ...
                        | 'ReadData transtype time' >> beam.io.ReadFromText('gs://sb-data-source/data_source_20210501/Transaction_Type_Time_20210607_102017.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        ...
                        # | 'ReadData transtype time' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource_20210501/Transaction_Type_Time_20210730_090714.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData transtype time' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-01-10days/01-10days-Transaction_Type_Time_202108021.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData transtype time' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-11-20days/11-20days-Transaction_Type_Time_202108023.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData transtype time' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-21-31days/21-31days-Transaction_Type_Time_202108022.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        ...
                        # | 'IgnoreUnicode transtype time' >> beam.Map(coder)
                        # | 'DecodeAndIgnoreUnicode transtype time' >> beam.Map(lambda line:line.decode("utf-8", "ignore"))
    ...
    partdics_data = (p 
                        ...
                        | 'ReadData partdisc' >> beam.io.ReadFromText('gs://sb-data-source/data_source_20210501/part_disc_20210607_095311.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        ...
                        # | 'ReadData partdisc' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource_20210501/part_disc_20210728_140151.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData partdisc' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-01-10days/01-10days-part_disc_20210801_210649.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData partdisc' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-11-20days/11-20days-part_disc_20210801_212643.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData partdisc' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-21-31days/21-31days-part_disc_20210801_214935.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        ...
                        # | 'IgnoreUnicode partdisc' >> beam.Map(coder)
                        # | 'DecodeAndIgnoreUnicode partdisc' >> beam.Map(lambda line:line.decode("utf-8", "ignore"))
    ...
    sales_transaction_data = (p 
                        ...
                        | 'ReadData transaction' >> beam.io.ReadFromText('gs://sb-data-source/data_source_20210501/sales_transactions_20210607_094416.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        ...
                        # | 'ReadData transaction' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource_20210501/sales_transactions_20210728_132936.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData transaction' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-01-10days/01-10days-sales_transactions_20210801_210110.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData transaction' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-11-20days/11-20days-sales_transactions_20210801_212107.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData transaction' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-21-31days/21-31days-sales_transactions_20210801_214416.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        ...
                        # | 'IgnoreUnicode transaction' >> beam.Map(coder)
                        # | 'DecodeAndIgnoreUnicode transaction' >> beam.Map(lambda line:line.decode("utf-8", "ignore"))
    ...
    sales_transaction_details_data = (p 
                        ...
                        | 'ReadData transaction details' >> beam.io.ReadFromText('gs://sb-data-source/data_source_20210501/sales_transaction_details_20210607_094608.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        ...
                        # | 'ReadData transaction details' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource_20210501/sales_transaction_details_20210728_133857.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData transaction details' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-01-10days/01-10days-sales_transaction_details_20210801_210422.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData transaction details' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-11-20days/11-20days-sales_transaction_details_20210801_212400.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData transaction details' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-21-31days/21-31days-sales_transaction_details_20210801_214652.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        ...
                        # | 'IgnoreUnicode transaction details' >> beam.Map(coder)
                        # | 'DecodeAndIgnoreUnicode transaction details' >> beam.Map(lambda line:line.decode("utf-8", "ignore"))
    ...
    daily_table_data = (p 
                        ...
                        | 'ReadData daily table' >> beam.io.ReadFromText('gs://sb-data-source/data_source_20210501/daily_table_20210607_094807.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        ...
                        # | 'ReadData daily table' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource_20210501/daily_table_20210728_140540.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData daily table' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-01-10days/01-10days-daily_table_20210801_211053.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData daily table' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-11-20days/11-20days-daily_table_20210801_212940.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData daily table' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-21-31days/21-31days-daily_table_20210801_215201.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        ...
                        # | 'IgnoreUnicode daily table' >> beam.Map(coder)
                        # | 'DecodeAndIgnoreUnicode daily table' >> beam.Map(lambda line:line.decode("utf-8", "ignore"))
    ...
    daily_order_data = (p 
                        ...
                        | 'ReadData daily order' >> beam.io.ReadFromText('gs://sb-data-source/data_source_20210501/daily_order_20210607_094920.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        ...
                        # | 'ReadData daily order' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource_20210501/daily_order_20210728_140624.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData daily order' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-01-10days/01-10days-daily_order_20210801_211102.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData daily order' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-11-20days/11-20days-daily_order_20210801_212949.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData daily order' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-21-31days/21-31days-daily_order_20210801_215211.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        ...
                        # | 'IgnoreUnicode daily order' >> beam.Map(coder)
                        # | 'DecodeAndIgnoreUnicode daily order' >> beam.Map(lambda line:line.decode("utf-8", "ignore"))
    ...
    item_master_data = (p 
                        # | 'ReadData item master' >> beam.io.ReadFromText('data_source_BOH/data_source_20210501_item_master_20210607_093216.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData item master' >> beam.io.ReadFromText('BOH_Data_20210501_03/3d_data_source_item_master_20210710_065110.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData item master' >> beam.io.ReadFromText('BOH_Data_20210501_09/9d_data_source_item_master_20210721_190846.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        | 'ReadData item master' >> beam.io.ReadFromText('gs://sb-data-source/data_source_20210501/item_master_20210607_093216.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData item master' >> beam.io.ReadFromText('gs://sb-data-source/3d_data_source_20210501/3d_data_source_item_master_20210710_065110.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData item master' >> beam.io.ReadFromText('gs://sb-data-source/9d_data_source_20210501/9d_data_source_item_master_20210721_190846.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData item master' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource_20210501/item_master_20210728_140512.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData item master' >> beam.io.ReadFromText('gs://sb-data-source/1m_datasource-20210501-01-10days/01-10days-item_master_20210801_211616.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'ReadData item master' >> beam.io.ReadFromText('gs://stbck_sales_data/3D_data_source_20210501/3d_data_source_item_master_20210710_065110.txt', skip_header_lines =1, coder=IgnoreUnicode())
                        # | 'IgnoreUnicode item master' >> beam.Map(coder)
                        # | 'DecodeAndIgnoreUnicode item master' >> beam.Map(lambda line:line.decode("utf-8", "ignore"))
                        ...
                        | 'Write item master' >> WriteToText('data_source_BOH/output/item_master_encoding_new','.txt')
                        )
...
#     # Dorder >< Dtable (UDAH RATA), function ok but upref (lt.wc, SL) blm keambil
    ...
    rmdup_dtdo = (dorder_dtable_output  | 'ConvertDictToStr dtdo' >> beam.Map(lambda x: str(x))
                                    | 'remove duplicate dtdo' >> beam.Distinct()
                                    | 'todict dtdo' >> beam.Map(convert_to_dict)
                                    # | 'Delete unwanted column for Table Fact' >> beam.Map(del_unwanted_cols_fact)  
    )
...
#     # test
    ...
    global list_data
    list_data = []
    def find_identic_trans_seq(data):
        global list_data
        


    fact_fact = (left_join_stdbaspdtdomtpd  | 'ConvertDictToStr fact last' >> beam.Map(lambda x: str(x))
                                    | 'fact dup last' >> beam.Distinct()
                                    | 'ConvertStrToDict fact last' >> beam.Map(lambda x: eval(x))
                                    | 'find identical trans and sequence' >> beam.Map(find_identic_trans_seq)
                                    | 'Delete unwanted column for Table Fact' >> beam.Map(del_unwanted_cols_fact)
                                    # | 'WriteToList to text' >> WriteToText('hasil-fact-last', '.txt')
    )
...
# ==================================================================================================
    ...
    # rmdup_dtdo | 'dtdo' >> beam.io.WriteToText('data_source_BOH/output/300721-dtdo-new_output3','.txt')
    
    # fact_fact | 'write stdetail >< st >< item_master' >> beam.io.WriteToText('data_source_BOH/output/310721-std-fact1d-new','.txt')
    ...
    # dorder_dtable_output | 'Write to BQ DODT FACT testing' >> beam.io.WriteToBigQuery(
    #                 table=table_id_dodt,
    #                 dataset=dataset_id,
    #                 project=project_id,

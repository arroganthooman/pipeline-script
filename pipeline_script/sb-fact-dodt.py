...
#     # Branchessap >< ST (UDAH RATA)
    ...
    st_bsap_dodt_right = 'st_bsap_dodt_output'

    std_st_bsap_dodt_keys = {
        std_left: ['transaction_number'],
        st_bsap_dodt_right: ['transaction_number']
    }

    std_st_bsap_dodt_join = {std_left: sales_transaction_details_data, st_bsap_dodt_right: st_bsap_dodt_output}

    std_st_bsap_dodt_output = (std_st_bsap_dodt_join  | 'std st bsap join' >> Join(left_pcol_name=std_left, left_pcol=sales_transaction_details_data,
                                                               right_pcol_name=st_bsap_dodt_right, right_pcol=st_bsap_dodt_output,
                                                               join_type='left', join_keys=std_st_bsap_dodt_keys)                                  
    )

    # Sales Transaction Detail >< MICROS
    std_st_bsap_left = 'std_st_bsap_dodt_output'
    ...
    std_bsap_micros_join = {std_st_bsap_left: std_st_bsap_dodt_output, factmicros_right: rm_duplicate_micros}

    std_bsap_micros_output = (std_bsap_micros_join | 'fact join 2' >> Join(left_pcol_name=std_st_bsap_left, left_pcol=std_st_bsap_dodt_output,
    ...
    # # DODT LEFT >< STD
    # dodt_left = 'dorder_dtable_output'
    # std_bsap_right = 'std_st_bsap_output'
    
    # fact_keys = {
    #     dodt_left: ['transaction_number', 'plu', 'qty'],
    #     std_bsap_right: ['transaction_number', 'plu', 'stdetail_qty']
    #     }

    # fact_join = {dodt_left: dorder_dtable_output, std_bsap_right: std_st_bsap_output}

    # fact_output = (fact_join | 'fact join' >> Join(left_pcol_name=dodt_left, left_pcol=dorder_dtable_output,
    #                                                            right_pcol_name=std_bsap_right, right_pcol=std_st_bsap_output,
    #                                                            join_type='all', join_keys=fact_keys)
    ...
    # dodt_right = 'daily_table_data'
    

    # std_dodt_key = {
    #     std_bsap_left: ['transaction_number'],
    #     dodt_right: ['transaction_number']
    #     }
    #     # order_idx stdetail_seq

    # fact_join = {std_bsap_left: std_bsap_micros_output, dodt_right: daily_table_data}

    # fact_std = (fact_join | 'fact join' >> Join(left_pcol_name=std_bsap_left, left_pcol=std_bsap_micros_output,
    #                                                            right_pcol_name=dodt_right, right_pcol=daily_table_data,
    ...
    stdbaspdtdomt_pd_data = 'std_bsap_micros_output'
    ...
    join_stdbaspdtdomtpd_dict = {stdbaspdtdomt_pd_data: std_bsap_micros_output, pd_data: partdics_data}

    # JOINED PCOLLECTIONS STDETAIL DTABLE DORDER MICRO TIME PART DISCOUNT
    left_join_stdbaspdtdomtpd = (join_stdbaspdtdomtpd_dict | 'Left Join STD DTDO MICRO TIME PART DISC' >> Join(left_pcol_name=stdbaspdtdomt_pd_data, left_pcol=std_bsap_micros_output,
...
# ==================================================================================================
    ...
    left_join_stdbaspdtdomtpd | 'write stdetail >< st >< item_master' >> beam.io.WriteToText('data_source_BOH/output/130821-dodt20','.txt')

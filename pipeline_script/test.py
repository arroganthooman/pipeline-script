...
def run(argv=None):
    ...
    DiscDailyDetails_data = (p 
                        ...
                        | 'AddToList DiscDailyDetails' >> beam.Map(addToList)
                        # | 'CreateFromNewList DiscDailyDetails' >> beam.Create(data_list)
    ...
    DiscDailyDetails_data = (p
                        | 'CreateFromNewList DiscDailyDetails' >> beam.Create([data_list])
                        | 'RemoveDuplicate DiscDailyDetails' >> beam.Map(rmduplicate)
